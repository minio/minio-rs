...
impl GetObjectResponse {
    ...
    ///
    /// This is more efficient than `content().to_segmented_bytes().await` for
    /// scenarios requiring minimal overhead, as it uses reqwest's native bytes
    /// collection without intermediate wrappers.
