...
pub use delete_object_annotation::DeleteObjectAnnotationResponse;
...
pub use get_object_annotation::GetObjectAnnotationResponse;
pub use get_object_attributes::*;
...
pub use list_object_annotations::{ListObjectAnnotationsResponse, ObjectAnnotation};
...
pub use put_object_annotation::PutObjectAnnotationResponse;
