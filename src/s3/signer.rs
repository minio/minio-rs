...
///
/// This is similar to `sign_v4_s3` but uses "s3tables" as the service name.
/// Does not use signing key caching since S3 Tables requests are less frequent.
