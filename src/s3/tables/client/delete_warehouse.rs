...
use crate::s3::tables::builders::{DeleteWarehouse, DeleteWarehouseBldr};
...
impl TablesClient {
    ...
    /// tables
    ///     .delete_warehouse("temp-warehouse")
    ///     .build()
    ///     .send()
    ///     .await?;
    ///
    ...
    /// tables
    ///     .delete_warehouse("migrating-warehouse")
    ...
    /// # }
    /// ```
    pub fn delete_warehouse<S: Into<String>>(&self, warehouse_name: S) -> DeleteWarehouseBldr {
