...
///
/// This operation returns an empty response on success.
/// The operation succeeds if the namespace was deleted or did not exist.
#[derive(Debug, Clone)]
pub struct DeleteNamespaceResponse {}

impl FromTablesResponse for DeleteNamespaceResponse {
