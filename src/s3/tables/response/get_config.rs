...
use crate::s3::tables::types::{CatalogConfig, FromTablesResponse, TablesRequest};

/// Response from GetConfig operation
pub type GetConfigResponse = CatalogConfig;

impl FromTablesResponse for GetConfigResponse {
