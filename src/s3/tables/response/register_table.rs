...
use crate::s3::tables::types::{FromTablesResponse, LoadTableResult, TablesRequest};
use serde::Deserialize;

/// Response from RegisterTable operation
#[derive(Debug, Clone, Deserialize)]
pub struct RegisterTableResponse(pub LoadTableResult);

impl FromTablesResponse for RegisterTableResponse {
    async fn from_response(request: TablesRequest) -> Result<Self, Error> {
        ...
        Ok(RegisterTableResponse(result))
    }
}
