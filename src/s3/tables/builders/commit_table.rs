...
use crate::s3::tables::iceberg::TableMetadata;
use crate::s3::tables::response::CommitTableResponse;
...
pub enum TableUpdate {
    ...
    AddSchema {
        schema: crate::s3::tables::iceberg::Schema,
    ...
    AddPartitionSpec {
        spec: crate::s3::tables::iceberg::PartitionSpec,
    },
    SetDefaultSpec {
        spec_id: i32,
    },
    AddSortOrder {
        sort_order: crate::s3::tables::iceberg::SortOrder,
    },
    SetDefaultSortOrder {
        sort_order_id: i32,
    },
    AddSnapshot {
        snapshot: crate::s3::tables::iceberg::Snapshot,
    },
    SetSnapshotRef {
        ref_name: String,
        r#type: String,
