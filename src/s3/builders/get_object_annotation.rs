...
use crate::s3::response::GetObjectAnnotationResponse;
use crate::s3::types::{
...
/// Argument builder for the GetObjectAnnotation AIStor API operation.
///
/// Returns the payload of a single named annotation. This struct constructs the
/// parameters required for the
/// [`MinioClient::get_object_annotation`](crate::s3::client::MinioClient::get_object_annotation) method.
...
/// Builder type for [`GetObjectAnnotation`] returned by
/// [`MinioClient::get_object_annotation`](crate::s3::client::MinioClient::get_object_annotation).
pub type GetObjectAnnotationBldr = GetObjectAnnotationBuilder<(
    (MinioClient,),
    (),
    (),
    (),
...
impl S3Api for GetObjectAnnotation {
    type S3Response = GetObjectAnnotationResponse;
}

impl ToS3Request for GetObjectAnnotation {
...
mod tests {
    ...
    fn empty_name_is_rejected_at_construction() {
        assert!(
            test_client()
                .get_object_annotation("bucket", "object", "")
                .is_err()
        );
    }
}
