...
use crate::s3::Client;
use crate::s3::args::StatObjectArgs;
use crate::s3::builders::{
    ContentStream, MAX_MULTIPART_COUNT, ObjectContent, SegmentedBytes, Size, calc_part_info,
};
...
impl AppendObjectContent {
    ...
    pub async fn send(mut self) -> Result<AppendObjectResponse, Error> {
        ...
        let resp: StatObjectResponse = client
            .stat_object(&StatObjectArgs::new(&self.bucket, &self.object)?)
            .await?;
