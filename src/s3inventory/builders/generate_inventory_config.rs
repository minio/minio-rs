...
use crate::s3inventory::{GenerateInventoryConfigResponse, InventoryJobId};
use http::Method;
...
pub type GenerateInventoryConfigBldr =
    GenerateInventoryConfigBuilder<((MinioClient,), (), (), (), (BucketName,), (InventoryJobId,))>;
...
impl ToS3Request for GenerateInventoryConfig {
    fn to_s3request(self) -> Result<S3Request, ValidationErr> {
        ...
        query_params.insert("generate".to_string(), String::new());
