...
use crate::s3inventory::{GetInventoryJobStatusResponse, InventoryJobId};
use http::Method;
...
pub type GetInventoryJobStatusBldr =
    GetInventoryJobStatusBuilder<((MinioClient,), (), (), (), (BucketName,), (InventoryJobId,))>;
...
impl ToS3Request for GetInventoryJobStatus {
    fn to_s3request(self) -> Result<S3Request, ValidationErr> {
        ...
        query_params.insert("status".to_string(), String::new());
