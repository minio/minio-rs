...
pub struct ListRemoteTargets {
    ...
    bucket: BucketName,
    #[builder(setter(into, doc = "Type specification"))]
    arn_type: String,
}

/// Builder type for [`ListRemoteTargets`].
pub type ListRemoteTargetsBldr = ListRemoteTargetsBuilder<((MadminClient,), (), (), (), ())>;
