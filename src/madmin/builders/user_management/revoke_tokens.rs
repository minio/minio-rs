...
use crate::madmin::response::RevokeTokensResponse;
...
/// Argument builder for the RevokeTokens admin API operation.
///
/// Revokes authentication tokens for builtin users or STS-authenticated external users.
///
/// This struct constructs the parameters required for the [`MadminClient::revoke_tokens`] method.
///
/// # Example
///
/// ```no_run
...
pub struct RevokeTokens {
    ...
    #[builder(setter(doc = "Token revocation request"))]
    request: RevokeTokensReq,
}

pub type RevokeTokensBldr = RevokeTokensBuilder<((MadminClient,), (), (), ())>;

impl ToMadminRequest for RevokeTokens {
...
impl MadminApi for RevokeTokens {
    type MadminResponse = RevokeTokensResponse;
}
