...
/// Argument builder for the Add Service Account (LDAP) admin API operation.
///
/// This struct constructs the parameters required for the [`MadminClient::add_service_account_ldap`](crate::madmin::madmin_client::MadminClient::add_service_account_ldap) method.
...
/// Builder type for [`AddServiceAccountLDAP`].
pub type AddServiceAccountLDAPBldr = AddServiceAccountLDAPBuilder<((MadminClient,), (), (), ())>;

impl ToMadminRequest for AddServiceAccountLDAP {
    fn to_madmin_request(self) -> Result<MadminRequest, Error> {
        ...
        let password = self
            ...
            .ok_or_else(|| {
                Error::Validation(ValidationErr::StrError {
                    message: "Credentials required for AddServiceAccountLDAP".to_string(),
                    source: None,
                })
            })?
            .fetch()
...
impl MadminApi for AddServiceAccountLDAP {
