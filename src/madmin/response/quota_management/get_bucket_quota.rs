...
impl_from_madmin_response!(GetBucketQuotaResponse);
impl_has_madmin_fields!(GetBucketQuotaResponse);
impl HasBucket for GetBucketQuotaResponse {}

impl GetBucketQuotaResponse {
    /// Returns the bucket quota configuration.
    pub fn quota(&self) -> Result<BucketQuota, ValidationErr> {
