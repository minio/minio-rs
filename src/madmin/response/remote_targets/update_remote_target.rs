...
#[derive(Clone, Debug)]
pub struct UpdateRemoteTargetResponse {
    request: MadminRequest,
    headers: HeaderMap,
    body: Bytes,
}

impl_from_madmin_response!(UpdateRemoteTargetResponse);
impl_has_madmin_fields!(UpdateRemoteTargetResponse);

impl UpdateRemoteTargetResponse {
    /// Returns the ARN of the updated remote target.
