...
impl_has_madmin_fields!(DeleteIdpConfigResponse);

impl DeleteIdpConfigResponse {
...
#[async_trait]
impl FromMadminResponse for DeleteIdpConfigResponse {
    async fn from_madmin_response(
        request: MadminRequest,
        response: Result<reqwest::Response, Error>,
    ) -> Result<Self, Error> {
        let mut resp = response?;
        Ok(DeleteIdpConfigResponse {
            request,
