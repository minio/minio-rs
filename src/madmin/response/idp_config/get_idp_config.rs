...
use crate::madmin::types::idp_config::IdpConfig;
...
impl_from_madmin_response!(GetIdpConfigResponse);
impl_has_madmin_fields!(GetIdpConfigResponse);

impl GetIdpConfigResponse {
    /// Returns the IDP configuration.
    pub fn config(&self) -> Result<IdpConfig, ValidationErr> {
