...
/// Response from the RevokeTokensLDAP admin API
#[derive(Debug, Clone)]
pub struct RevokeTokensLDAPResponse;

//TODO did you forget to refactor from_madmin_response here?
#[async_trait]
impl FromMadminResponse for RevokeTokensLDAPResponse {
