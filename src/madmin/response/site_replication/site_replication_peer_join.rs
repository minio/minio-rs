...
/// Response from site replication peer join operation
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SiteReplicationPeerJoinResponse {
    pub status: String,
...
#[async_trait]
impl FromMadminResponse for SiteReplicationPeerJoinResponse {
    async fn from_madmin_response(
        ...
        let result: SiteReplicationPeerJoinResponse = serde_json::from_slice(&body)
