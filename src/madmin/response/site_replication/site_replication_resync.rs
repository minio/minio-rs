...
/// Response from site replication resync operation
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SiteReplicationResyncResponse {
    pub status: String,
...
#[async_trait]
impl FromMadminResponse for SiteReplicationResyncResponse {
    async fn from_madmin_response(
        ...
        let result: SiteReplicationResyncResponse = serde_json::from_slice(&body)
