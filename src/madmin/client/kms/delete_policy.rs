...
use crate::madmin::builders::{DeletePolicy, DeletePolicyBldr};
use crate::madmin::madmin_client::MadminClient;

impl MadminClient {
    /// Delete a KMS policy
    ///
    /// Removes a policy from the KMS server.
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// # }
    /// ```
    pub fn delete_policy(&self) -> DeletePolicyBldr {
        DeletePolicy::builder().client(self.clone())
    }
}
