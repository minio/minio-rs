...
//! Client method for GetTableMaintenanceJobStatus operation

use crate::s3::error::ValidationErr;
use crate::s3tables::builders::{GetTableMaintenanceJobStatus, GetTableMaintenanceJobStatusBldr};
use crate::s3tables::client::TablesClient;
use crate::s3tables::types::MaintenanceType;
...
impl TablesClient {
    ...
    /// * `maintenance_type` - The type of maintenance job
    ///
    /// # Example
    ///
    /// ```no_run
    ...
    /// # }
    /// ```
    pub fn get_table_maintenance_job_status<W, N, T>(
        &self,
        warehouse: W,
        namespace: N,
        table: T,
        maintenance_type: MaintenanceType,
    ) -> Result<GetTableMaintenanceJobStatusBldr, ValidationErr>
    where
    ...
    {
        Ok(GetTableMaintenanceJobStatus::builder()
            .client(self.clone())
