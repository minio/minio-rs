...
use crate::s3tables::builders::{UpdateNamespacePropertiesBldr, UpdateNamespacePropertiesRequired};
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn update_namespace_properties<W, N>(
        &self,
        warehouse: W,
        namespace: N,
    ) -> Result<UpdateNamespacePropertiesBldr, ValidationErr>
    where
    ...
    {
        Ok(UpdateNamespacePropertiesRequired::builder()
            .client(self.clone())
