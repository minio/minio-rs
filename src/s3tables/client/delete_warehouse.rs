...
impl TablesClient {
    ...
    /// # Arguments
    ///
    /// * `warehouse` - Name of the warehouse to delete (or string to validate)
    ///
    /// # Optional Parameters
    ///
    ...
    /// # }
    /// ```
    pub fn delete_warehouse<W>(&self, warehouse: W) -> Result<DeleteWarehouseBldr, ValidationErr>
    where
        W: TryInto<WarehouseName>,
        W::Error: Into<ValidationErr>,
    {
        Ok(DeleteWarehouse::builder()
            .client(self.clone())
