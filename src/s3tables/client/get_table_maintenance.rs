...
//! Client method for GetTableMaintenance operation

use crate::s3::error::ValidationErr;
use crate::s3tables::builders::{GetTableMaintenance, GetTableMaintenanceBldr};
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn get_table_maintenance<W, N, T>(
        &self,
        warehouse: W,
        namespace: N,
        table: T,
    ) -> Result<GetTableMaintenanceBldr, ValidationErr>
    where
    ...
    {
        Ok(GetTableMaintenance::builder()
            .client(self.clone())
