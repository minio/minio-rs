...
//! Client method for GetTableEncryption operation

use crate::s3::error::ValidationErr;
use crate::s3tables::builders::{GetTableEncryption, GetTableEncryptionBldr};
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn get_table_encryption<W, N, T>(
        &self,
        warehouse: W,
        namespace: N,
        table: T,
    ) -> Result<GetTableEncryptionBldr, ValidationErr>
    where
