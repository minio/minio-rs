...
//! Client method for DeleteWarehousePolicy operation

use crate::s3::error::ValidationErr;
use crate::s3tables::builders::{DeleteWarehousePolicy, DeleteWarehousePolicyBldr};
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn delete_warehouse_policy<W>(
        &self,
        warehouse: W,
    ) -> Result<DeleteWarehousePolicyBldr, ValidationErr>
    where
        W: TryInto<WarehouseName>,
        W::Error: Into<ValidationErr>,
    {
        Ok(DeleteWarehousePolicy::builder()
            .client(self.clone())
