...
//! Client method for PutTableMaintenance operation
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn put_table_maintenance<W, N, T>(
        &self,
        warehouse: W,
        namespace: N,
        table: T,
        config: TableMaintenanceConfig,
    ) -> Result<PutTableMaintenanceBldr, ValidationErr>
    where
    ...
    {
        Ok(PutTableMaintenance::builder()
            .client(self.clone())
