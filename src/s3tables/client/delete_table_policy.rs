...
//! Client method for DeleteTablePolicy operation

use crate::s3::error::ValidationErr;
use crate::s3tables::builders::{DeleteTablePolicy, DeleteTablePolicyBldr};
...
impl TablesClient {
    ...
    /// # }
    /// ```
    pub fn delete_table_policy<W, N, T>(
        &self,
        warehouse: W,
        namespace: N,
        table: T,
    ) -> Result<DeleteTablePolicyBldr, ValidationErr>
    where
