...
//! Builder for GetTablePolicy operation
//!
//! AWS S3 Tables API: `GET /tables/{tableARN}/policy`
//! Spec: <https://docs.aws.amazon.com/AmazonS3/latest/API/API_s3tables_GetTablePolicy.html>

use crate::s3::error::ValidationErr;
use crate::s3tables::client::TablesClient;
use crate::s3tables::response::GetTablePolicyResponse;
...
/// Argument builder for GetTablePolicy operation
///
/// Gets the resource-based policy for a table.
///
/// # Permissions
///
/// Requires `s3tables:GetTablePolicy` permission.
///
/// # Example
///
/// ```no_run
...
impl TablesApi for GetTablePolicy {
    type TablesResponse = GetTablePolicyResponse;
}

/// Builder type for GetTablePolicy
pub type GetTablePolicyBldr = GetTablePolicyBuilder<(
    (TablesClient,),
    (WarehouseName,),
    (Namespace,),
    (TableName,),
...
impl ToTablesRequest for GetTablePolicy {
