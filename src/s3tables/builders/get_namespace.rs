...
//!
//! Iceberg REST API: `GET /v1/{prefix}/namespaces/{namespace}`
//! Spec: <https://github.com/apache/iceberg/blob/main/open-api/rest-catalog-open-api.yaml#L282>
...
/// let response = tables
///     .get_namespace(
///         WarehouseName::new("my-warehouse")?,
...
pub type GetNamespaceBldr = GetNamespaceBuilder<((TablesClient,), (WarehouseName,), (Namespace,))>;
