...
use crate::s3tables::utils::{Namespace, TableName, WarehouseName, namespace_path};
use http::Method;
use serde::Serialize;
...
pub struct RegisterTable {
    ...
    metadata_location: String, // Consider creating a dedicated MetadataLocation newtype for better type safety
