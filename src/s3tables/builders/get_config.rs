...
//!
//! Iceberg REST API: `GET /v1/config`
//! Spec: <https://github.com/apache/iceberg/blob/main/open-api/rest-catalog-open-api.yaml#L142>
...
pub type GetConfigBldr = GetConfigBuilder<((TablesClient,), (WarehouseName,))>;

impl ToTablesRequest for GetConfig {
    fn to_tables_request(self) -> Result<TablesRequest, ValidationErr> {
        let mut query_params = crate::s3::multimap_ext::Multimap::new();
        query_params.insert("warehouse".to_string(), self.warehouse_name.into_inner());
