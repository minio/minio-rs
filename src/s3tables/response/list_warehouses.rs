...
use crate::s3tables::response_traits::{HasPagination, HasWarehouseName};
    ...
    pub fn warehouses(&self) -> Result<Vec<String>, ValidationErr> {
        ...
        json.get("warehouses")
            ...
            .ok_or_else(|| ValidationErr::StrError {
                message: "Missing or invalid 'warehouses' field in ListWarehouses response".into(),
                source: None,
            })
    }
}
...
impl HasWarehouseName for ListWarehousesResponse {}
