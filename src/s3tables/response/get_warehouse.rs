...
//! # Specification
//!
//! Implements the response for retrieving warehouse details. This is a MinIO-specific extension
//! to the Iceberg REST Catalog API for managing S3 Tables warehouses.
//!
//! ## Response (HTTP 200)
//!
//! Returns the warehouse details including name, UUID, bucket, and creation time.
//!
//! ## Response Schema
//!
...
/// # Specification
///
/// Retrieves warehouse details (MinIO-specific extension to Iceberg REST Catalog API).
///
/// # Available Fields
///
/// - [`warehouse()`](crate::s3tables::HasWarehouseName::warehouse) - Returns the warehouse name
...
impl_has_tables_fields!(GetWarehouseResponse);
impl_from_tables_response_cached!(GetWarehouseResponse);
impl_has_cached_body!(GetWarehouseResponse);

impl HasWarehouseName for GetWarehouseResponse {}
impl HasBucket for GetWarehouseResponse {}
impl HasUuid for GetWarehouseResponse {}
impl HasCreatedAt for GetWarehouseResponse {}
