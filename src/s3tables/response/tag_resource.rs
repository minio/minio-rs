...
//! Response type for TagResource operation
...
/// Response from TagResource operation
///
...
impl_has_tables_fields!(TagResourceResponse);
impl_from_tables_response_cached!(TagResourceResponse);
impl_has_cached_body!(TagResourceResponse);
