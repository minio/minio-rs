...
//! Response type for DeleteWarehousePolicy operation
...
/// Response from DeleteWarehousePolicy operation
///
/// This is an empty response indicating success (HTTP 204 No Content).
#[derive(Debug)]
pub struct DeleteWarehousePolicyResponse {
...
impl_has_tables_fields!(DeleteWarehousePolicyResponse);
impl_from_tables_response_cached!(DeleteWarehousePolicyResponse);
impl_has_cached_body!(DeleteWarehousePolicyResponse);
