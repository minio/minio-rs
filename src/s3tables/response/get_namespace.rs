...
//! # Specification
//!
//! Implements the response for `GET /v1/{prefix}/namespaces/{namespace}` from the
//! [Apache Iceberg REST Catalog API](https://github.com/apache/iceberg/blob/main/open-api/rest-catalog-open-api.yaml).
//!
//! ## Response (HTTP 200)
//!
//! Returns a namespace, as well as any properties stored on the namespace if namespace
//! properties are supported by the server.
//!
//! ## Response Schema (GetNamespaceResponse)
//!
//! | Field | Type | Description |
//! |-------|------|-------------|
//! | `namespace` | `array[string]` | Reference to a namespace, e.g., `["accounting", "tax"]` |
//! | `properties` | `object` or `null` | Properties stored on the namespace. Null if server doesn't support namespace properties. |
...
/// # Specification
///
/// Implements `GET /v1/{prefix}/namespaces/{namespace}` (HTTP 200 response) from the
/// [Apache Iceberg REST Catalog API](https://github.com/apache/iceberg/blob/main/open-api/rest-catalog-open-api.yaml).
///
/// # Available Fields
///
...
/// - [`properties()`](crate::s3tables::HasProperties::properties) - Returns namespace properties (empty if not supported)
#[derive(Debug)]
...
impl_from_tables_response_cached!(GetNamespaceResponse);
impl_has_cached_body!(GetNamespaceResponse);
