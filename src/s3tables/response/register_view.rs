...
//! Response type for RegisterView operation
//!
//! # Specification
//!
//! Implements the response for `POST /v0/{warehouse}/namespaces/{namespace}/views/register`
//! from the MinIO AIStor extension API.
//!
//! ## Response (HTTP 200)
//!
//! Returns the complete view metadata after registration.
//!
...
/// Response from RegisterView operation
///
/// # Specification
///
/// Implements `POST /v0/{warehouse}/namespaces/{namespace}/views/register` (HTTP 200 response)
/// from the MinIO AIStor extension API.
///
/// # Available Fields
///
...
impl_has_tables_fields!(RegisterViewResponse);
impl_from_tables_response_with_cache!(RegisterViewResponse);
impl_has_cached_view_result!(RegisterViewResponse);
