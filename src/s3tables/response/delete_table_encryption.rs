...
//! Response type for DeleteTableEncryption operation
...
/// Response from DeleteTableEncryption operation
///
/// This is an empty response indicating success (HTTP 204 No Content).
#[derive(Debug)]
pub struct DeleteTableEncryptionResponse {
...
impl_has_tables_fields!(DeleteTableEncryptionResponse);
impl_from_tables_response_cached!(DeleteTableEncryptionResponse);
impl_has_cached_body!(DeleteTableEncryptionResponse);

impl HasWarehouseName for DeleteTableEncryptionResponse {}
