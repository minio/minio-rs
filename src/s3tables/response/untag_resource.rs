...
//! Response type for UntagResource operation
...
/// Response from UntagResource operation
///
...
impl_has_tables_fields!(UntagResourceResponse);
impl_from_tables_response_cached!(UntagResourceResponse);
impl_has_cached_body!(UntagResourceResponse);
