...
#[minio_macros::test]
async fn get_object_1(ctx: TestContext, bucket_name: BucketName) {
    let object_name = rand_object_name_utf8(20);
    test_get_object(&ctx, bucket_name.as_str(), object_name.as_str()).await;
}

/// Test getting an object with a name that contains white space characters.
#[minio_macros::test]
async fn get_object_2(ctx: TestContext, bucket_name: BucketName) {
    test_get_object(&ctx, bucket_name.as_str(), "a b+c").await;
}

/// Test into_bytes method for direct byte retrieval.
#[minio_macros::test]
async fn get_object_into_bytes(ctx: TestContext, bucket_name: BucketName) {
    let object_name = rand_object_name_utf8(20);
...
#[minio_macros::test]
async fn get_object_into_boxed_stream(ctx: TestContext, bucket_name: BucketName) {
    let object_name = rand_object_name_utf8(20);
...
#[minio_macros::test]
async fn get_object_into_boxed_stream_large(ctx: TestContext, bucket_name: BucketName) {
    let object_name = rand_object_name_utf8(20);
...
#[minio_macros::test]
async fn get_object_into_bytes_empty(ctx: TestContext, bucket_name: BucketName) {
    let object_name = rand_object_name_utf8(20);
