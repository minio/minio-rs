...
async fn object_tags(ctx: TestContext, bucket: BucketName) {
    ...
    let resp: PutObjectTaggingResponse = ctx
        .client
        .put_object_tagging(&bucket, &object)
        .unwrap()
        .tags(tags.clone())
        .build()
        .send()
    ...
    let resp: GetObjectTaggingResponse = ctx
        .client
        .get_object_tagging(&bucket, &object)
        .unwrap()
        .build()
        .send()
        .await
    ...
    let resp: DeleteObjectTaggingResponse = ctx
        .client
        .delete_object_tagging(&bucket, &object)
        .unwrap()
        .build()
        .send()
        .await
