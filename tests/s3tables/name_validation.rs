...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_too_short_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_exceeds_max_length_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_uppercase_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_starts_with_hyphen_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_ends_with_hyphen_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
...
#[minio_macros::test(no_bucket)]
async fn warehouse_name_with_period_fails(ctx: TestContext) {
    let tables = create_tables_client(&ctx);
