...
async fn advanced_rename_table_with_namespace_change(ctx: TestContext) {
    ...
    tables
        .create_namespace(warehouse_name.clone(), source_namespace.clone())
        .build()
        .send()
        .await
        .unwrap();
    ...
    tables
        .create_namespace(warehouse_name.clone(), dest_namespace.clone())
        .build()
        .send()
        .await
        .unwrap();
    ...
    let _rename_resp = RenameTable::builder()
        ...
        .dest_table_name(new_table_name.clone())
        .build()
        .send()
        .await
        .unwrap();
    ...
    let resp: Result<_, Error> = tables
        .load_table(warehouse_name.clone(), source_namespace.clone(), table_name)
        .build()
        .send()
        .await;
    assert!(
    ...
    tables
        .delete_namespace(warehouse_name.clone(), source_namespace.clone())
        .build()
        .send()
        .await
        .unwrap();
    ...
    let resp: Result<_, Error> = tables
        .get_namespace(warehouse_name.clone(), source_namespace)
        .build()
        .send()
        .await;
    assert!(
    ...
    tables
        .delete_namespace(warehouse_name.clone(), dest_namespace.clone())
        .build()
        .send()
        .await
        .unwrap();
    ...
    let resp: Result<_, Error> = tables
        .get_namespace(warehouse_name.clone(), dest_namespace)
        .build()
        .send()
        .await;
    assert!(
